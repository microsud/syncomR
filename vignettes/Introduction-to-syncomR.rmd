...
The `syncomR` is an R package consisting of functions for use with time-series microbial census data. The package is mainly accompanying the research article "Minimalist Approach for Deciphering the Ecophysiology of Human Gut Microbes" Shetty SA., et al 2020. Therefore, the functions have been tested using a synthetic minimal microbiome that was assembled in three bioreactors. Published R codes were wrapped for convenient handling of the temporal census data of synthetic minimal microbiome. Therefore, this package is considered as a research compendium for organizing and sharing codes and files pertaining to the said research article.    
